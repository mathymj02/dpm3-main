...
const plantelMasculinoData: Jugador[] = [
  { 
    ...
    edad: 26, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Luis-Ureta.webp', 
  ...
  { 
    ...
    edad: 28, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/04/VICENTE-YANEZ.webp', 
  ...
  { 
    ...
    edad: 29, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Maximiliano-Riveros.webp', 
  ...
  { 
    ...
    edad: 24, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/04/DANIEL-BAHAMONDE.webp', 
  ...
  { 
    ...
    edad: 27, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/04/BYRON-NIETO.webp', 
  ...
  { 
    ...
    edad: 32, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Jesus-Pino.webp', 
  ...
  { 
    ...
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/04/JUAN-JAIME.webp', 
  ...
  { 
    ...
    edad: 26, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/04/GABRIEL-CASTILLO.webp', 
  ...
  { 
    ...
    edad: 23, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Danilo-Diaz.webp', 
  ...
  { 
    ...
    edad: 25, 
    nacionalidad: 'Chile', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Cristobal-Vargas.webp', 
  ...
  { 
    ...
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Reiner-Castro.webp', 
  ...
  { 
    ...
    edad: 38, 
    nacionalidad: 'Argentina', 
    fotoUrl: 'https://dpmchile.cl/wp-content/uploads/2026/03/Luciano-Vasquez.webp', 
